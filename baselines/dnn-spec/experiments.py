...
#               OrderedDict([('dataset', 'multispeaker'), ('upsample', 2), ('model', 'dnn'), ('phase', 'regression'), ('subsample', 0.01)])]
#experiments = [OrderedDict([('dataset', 'speaker1'), ('upsample', 4), ('model', 'dnn'), ('phase', 'regression')])]
experiments += [OrderedDict([('dataset', 'multispeaker'), ('upsample', 2), ('model', 'dnn'), ('phase', 'regression'), ('subsample', 1)])]
#
